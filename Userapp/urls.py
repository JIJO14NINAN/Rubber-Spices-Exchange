...
urlpatterns = [
    ...
    path('cart_view/', Userapp.views.cart_view, name='cart_view'),
    path('add_to_cart/',Userapp.views.add_to_cart,name='add_to_cart'),
    path('cart_remove/<int:id>/', Userapp.views.cart_remove, name='cart_remove'),
    path('cancel_order/<int:id>/', Userapp.views.cancel_order, name='cancel_order'),
    path('orders_view/',Userapp.views.orders_view,name='orders_view'),
    path('user_orders/', Userapp.views.user_orders, name='user_orders'),
